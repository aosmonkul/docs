...
This Data Processing Agreement ("DPA") is automatically incorporated into and forms part of our [Terms of Service](https://docs.memoraprivacy.com/terms-of-use). By using our Services, you agree to this DPA, which describes how we process data through our voice recording and transcription services. This DPA should be read together with our [Privacy Policy](https://docs.memoraprivacy.com/privacy-policy), which provides additional details about our data processing practices.
...
[List of Sub-Processors](https://www.gollumassistant.com/list-of-sub-processors)
...
2. Company will provide advance notice of any changes to our sub-processor list through our website or direct notification. All sub-processors are bound by contractual data protection requirements, and Company maintains oversight responsibility for their compliance with this DPA.
